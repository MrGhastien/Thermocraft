...
public class SolidHeaterContainer extends BaseContainer {
    ...
    public SolidHeaterContainer(SolidHeaterBlockEntity tileEntity, int id, Inventory playerInventory) {
    ...
    public static SolidHeaterContainer createClient(int id, Inventory inv, FriendlyByteBuf data) {
        ...
        if(te instanceof SolidHeaterBlockEntity) {
            return new SolidHeaterContainer((SolidHeaterBlockEntity) te, id, inv);
        }
        return null;
    }
}
